package com.nukkitx.protocol.bedrock.v9.serializer;
...
public class LoginSerializer_v9 implements BedrockPacketSerializer<LoginPacket> {
    public static final LoginSerializer_v9 INSTANCE = new LoginSerializer_v9();
