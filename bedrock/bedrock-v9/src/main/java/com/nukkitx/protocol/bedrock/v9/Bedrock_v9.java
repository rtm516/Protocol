package com.nukkitx.protocol.bedrock.v9;
...
import com.nukkitx.protocol.bedrock.v9.serializer.LoginSerializer_v9;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v9 {
    public static BedrockPacketCodec V9_CODEC = BedrockPacketCodec.builder()
            .protocolVersion(9)
            .minecraftVersion("0.6.1")
            .helper(BedrockPacketHelper_v407.INSTANCE)
            .registerPacket(LoginPacket.class, LoginSerializer_v9.INSTANCE, 130)
